...
t_max = 12 # total simulation duration in seconds
IS_SHOWING_2DVISUALIZATION = True
ROBOT_NUM = 4
CLUSTER_NUM = 2

# Initial state
init_state = np.array([[0., 0., 0.], [0., .7, 0.], \
                       [0., 5., 0.], [0., 4.3, 0.]]).flatten()  # px, py, theta

goal = np.array([[5., 4., 0.], [4.3, 4., 0.], \
                 [5., 0., 0.], [4.3, 0., 0.]]).flatten()  # px, py, theta


# Formation definition
ELL_EPS = 0.0
HALF_WIDTH = 0.7 + ELL_EPS
HALF_HEIGHT = 0.5 + ELL_EPS
NEIGHBOR_DIST = 0.7
EPSILON = 0.005
...
def simulate_control():
    ...
    h_history = np.zeros((sim_iter, ROBOT_NUM * (CLUSTER_NUM - 1 + robot_per_cluster)))
